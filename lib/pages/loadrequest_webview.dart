...
class LoadRequestWebView extends StatefulWidget {
  const LoadRequestWebView({Key? key, required this.url}) : super(key: key);
  final String url;

  @override
  State<LoadRequestWebView> createState() => _LoadRequestWebViewState();
}

class _LoadRequestWebViewState extends State<LoadRequestWebView> {
  bool isLoading = true;
