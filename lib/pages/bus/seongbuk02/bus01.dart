...
class Bus01 extends StatefulWidget {
  const Bus01({Key? key}) : super(key: key);

  @override
  State<Bus01> createState() => _Bus01State();
}

class _Bus01State extends State<Bus01> {
  ...
  getSeongBuk02() async {
    ...
    seongBuk02Info['arriveInfo'].add(seongBuk02Info['arriveInfo'][0]);

    for (int i = 0; i < 18; i++) {
      seongBuk02Info['arriveInfo'].removeAt(0);
    }
